...
class Master_jenis_baju_model extends DT_Model
{
	public $table_name = 'master_jenis_baju';
	protected $key = 'id';
	...
	protected $validation_rules = array(
		array(
			'field' => 'nama_jenis',
			'label' => 'lang:master_jenis_baju_field_nama_jenis',
			'rules' => 'required|max_length[50]',
		),
		array(
			'field' => 'keterangan',
			'label' => 'lang:master_jenis_baju_field_keterangan',
