...
$route[SITE_AREA . '/backup/per_id/files/(:num)'] = 'backup/backup/dokumen_per_id_files/$1';
...
$route[SITE_AREA . '/backup/per_folder/files'] = 'backup/backup/dokumen_per_folder_files';
