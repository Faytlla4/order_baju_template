<?php
$btn_id    = isset($btn_id)    ? $btn_id    : 'btn-excel';
$btn_class = isset($btn_class) ? $btn_class : 'btn-success';
$btn_icon  = isset($btn_icon)  ? $btn_icon  : 'fas fa-file-excel';
$btn_label = isset($btn_label) ? $btn_label : 'Export Excel';
?>
