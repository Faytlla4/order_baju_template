        ...
        <div class="navbar-inner">
            <div class="container-fluid">
                ...
                <div class="nav-collapse in collapse">
                    ...
                    <?php
                    $contextNav = Contexts::render_menu('text', 'normal');
                    $transaksi_url = site_url(SITE_AREA . '/transaksi/transaksi');
                    $transaksi_active = (strpos(current_url(), SITE_AREA . '/transaksi') !== false) ? ' active' : '';
                    $transaksiLi = '<li class="dropdown' . $transaksi_active . '">'
                        . '<a href="' . $transaksi_url . '" id="tb_transaksi" title="Transaksi" data-id="transaksi_menu">Transaksi<span class="caret"></span></a>'
                        . '<ul class="dropdown-menu">'
                        . '<li><a href="' . $transaksi_url . '" title="Daftar Transaksi">Daftar Transaksi</a></li>'
                        . '</ul>'
                        . '</li>';
                    $lastUlPos = strrpos($contextNav, '</ul>');
                    if ($lastUlPos !== false) {
                        $contextNav = substr($contextNav, 0, $lastUlPos) . $transaksiLi . substr($contextNav, $lastUlPos);
                    }
                    echo $contextNav;
                    ?>
                </div><!-- /.nav-collapse -->
